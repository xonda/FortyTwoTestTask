...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'hello_info', 'photo',
                      self.gf('django.db.models.fields.files.ImageField')(default='default_image.jpg', max_length=100),
                      keep_default=False)
    ...
    models = {
        u'hello.info': {
            ...
            'photo': ('django.db.models.fields.files.ImageField', [], {'default': "'default_image.jpg'", 'max_length': '100'}),
